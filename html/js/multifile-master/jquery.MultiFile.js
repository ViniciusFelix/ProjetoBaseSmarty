...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: 'Arquivo .$ext nao permitido, tente novamente...',
			file: '$file',
			selected: 'File selected: $file',
			duplicate: 'Arquivo esta selecionado: $file',
			toomuch: 'O arquivo selecionado ultrapassa o tamanho permitido ($size)',
